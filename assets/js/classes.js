...
var TOWN = {
	...
	addBuilding: function(pickedMeshId, price, meshName, yPos, type, income, openTime, maxPeople) {
		...
		if(TOWN.bankAmount >= price) {
			...
			BABYLON.SceneLoader.ImportMesh("Model", "assets/babylon_files/", meshName + ".babylon", scene, function (meshes) {
				...
				if(type == "residential") {
					...
					for(var j = 0; j < maxPeople; j++){
						BABYLON.SceneLoader.ImportMesh("Model", "assets/babylon_files/", "person.babylon", scene, function (personMesh) {
